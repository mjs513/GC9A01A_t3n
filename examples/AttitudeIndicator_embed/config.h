...
// If this one is defined we will use the RLE version of bitmap
#define USE_RLE_IMAGE
...
#define SCREEN_WIDTH GC9A01A_TFTWIDTH
#endif
...
#define BMP_PIXEL_NOT_SET  (BMP_TRANSPARENT - 1)
