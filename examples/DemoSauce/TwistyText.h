...
void TwistyText::init( GC9A01A_t3n tft ) {
...
void TwistyText::reset( GC9A01A_t3n tft ) {
...
void TwistyText::perFrame( GC9A01A_t3n tft, FrameParams frameParams ) {
